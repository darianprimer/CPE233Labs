...
#set_property PACKAGE_PIN R3 [get_ports {Demo}]					
...
#set_property PACKAGE_PIN R2 [get_ports {RC}]					
...
set_property PACKAGE_PIN P1 [get_ports {INTERUPT}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INTERUPT}]
...
set_property PACKAGE_PIN W19 [get_ports BTN_INT]						
	set_property IOSTANDARD LVCMOS33 [get_ports BTN_INT]
#set_property PACKAGE_PIN T17 [get_ports BTNC]						
#	set_property IOSTANDARD LVCMOS33 [get_ports BTNC]
#set_property PACKAGE_PIN U17 [get_ports BTN_INT]						
#	set_property IOSTANDARD LVCMOS33 [get_ports BTN_INT]
...
##Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports INTERUPT]					
	set_property IOSTANDARD LVCMOS33 [get_ports INTERUPT]
